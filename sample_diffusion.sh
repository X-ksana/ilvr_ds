...
MODEL_FLAGS="--attention_resolutions 16 --class_cond False --diffusion_steps 1000 --image_size 256 --learn_sigma True --noise_schedule linear --num_channels 128 --num_head_channels 64 --num_res_blocks 2 --resblock_updown True --use_fp16 False --use_scale_shift_norm True --in_channels 6 --out_channels 6 --mask_channels 3"
COMMON_ARGS="--batch_size 1 --num_samples 100 --timestep_respacing 100 --model_path results/log_dm/log_1000_mask/model100000.pt --ref_dir ref_imgs --scale 6 --use_mask True"
